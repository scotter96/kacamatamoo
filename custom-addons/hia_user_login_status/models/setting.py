...
class Setting(models.TransientModel):
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].set_param('hia_user_login_status.store_user_time',
    ...
    def get_values(self):
        ...
        store_user_time = config_params.get_param('hia_user_login_status.store_user_time')
        res.update(
